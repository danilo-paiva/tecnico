...
Exceções: `POST /compras` (comprar) vale para todo logado, mas o comum só
para si mesmo — 403 caso contrário.)
...
| 403 | perfil comum em escrita indevida / compra para outro participante |
